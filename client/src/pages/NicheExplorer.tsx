    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-youtube-light-gray p-4">
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-youtube-black">Niche Explorer</h1>
            <p className="text-youtube-gray">Explore and compare different YouTube content niches</p>
          </div>
          
          <div className="bg-white rounded-lg shadow-sm p-8 text-center">
            <h2 className="text-xl font-medium text-youtube-black mb-4">Coming Soon</h2>
            <p className="text-youtube-gray">
              This feature is currently in development. Check back soon for the niche explorer!
            </p>
          </div>
        </main>
      </div>
